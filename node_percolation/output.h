#ifndef NODE_PERCOLATION_OUTPUT_H
#define NODE_PERCOLATION_OUTPUT_H
...
// Legacy helper to dump buffered data (used if not streaming)
...
#endif // NODE_PERCOLATION_OUTPUT_H
